...
const awardSchema = z.object({
  ...
  year: z.string().regex(/^\d{4}$/, "Geçerli bir yıl giriniz (örn: 2023)"),
...
export const AddDoctorFormSchema = z.object({
  ...
  speciality: z.string().min(3, "Uzmanlık alanı en az 3 karakter olmalı"),
  ...
  education: z
    .array(
      z.object({
        ...
        institution: z.string().min(1, "Kurum gerekli"),
        year: z
          .number()
  ...
  patients: z.number().min(0, "Hasta sayısı 0'dan küçük olamaz").optional(),
